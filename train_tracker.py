...
def train_model(video_path, num_epochs=50, batch_size=8, save_path='tracker_model.pth'):
    """训练模型"""
    # 创建数据集
    ...
    model = TargetTrackingTransformer().to(device)
...
if __name__ == "__main__":
    ...
    train_model(video_path, num_epochs=50, batch_size=8, save_path='tracker_model.pth')
