        ...
        while True:
            ...
            if self.tracking and self.tracker:
                ...
                if self.bbox is not None and not self.tracking:
                    x, y, w, h = self.bbox
                    cv2.rectangle(display_frame, (x, y), (x + w, y + h), (0, 255, 0), 2)
                    cv2.putText(display_frame, "Selected Target", (x, y - 10),
                               cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
                ...
                # 显示状态
                cv2.putText(display_frame, "Press SPACE to start tracking",
            ...
            if self.total_frames > 0:
                ...
                print(f"\r进度: [{progress_bar}] {progress}%", end='', flush=True)
...
def parse_args():
    ...
    parser.add_argument('--tracker', type=str, default='kcf', choices=['kcf', 'resnet', 'custom'],
